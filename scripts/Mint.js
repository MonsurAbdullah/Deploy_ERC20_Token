 ...
 async function main() {
    const replace_contractAddress = "0x6C7CcE6dcEe9a405BbD9A7e830E9af4d48Ef8cF2";
    const [signer] = await hre.ethers.getSigners();
    const replace_contractFactory = await hre.ethers.getContractFactory("DigitalAssets");
    const contract = replace_contractFactory.attach(replace_contractAddress);
  
    const replace_functionName = "mint";
    const replace_functionArgs = ["0x18963378D34b17923b5e3ee1581B6379eA87E3CB","100000000000000000000"]; // 100 tokens with 18 decimal places
